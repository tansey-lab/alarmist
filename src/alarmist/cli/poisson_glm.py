...
def get_parser():
    ...
    # Input/Output
    parser.add_argument('--bptf-dir', '--results-dir', dest='bptf_dir',
                       required=True,
                       help='BPTF results directory')
    parser.add_argument('--patch-lri-dir',
                       default=None,
