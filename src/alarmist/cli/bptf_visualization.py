...
Note: Simplified version based on 03_bptf_visualization.py
"""
...
def get_parser():
    ...
    parser.add_argument(
        "--bptf-dir", required=True, help="Directory containing BPTF results"
    )
    parser.add_argument(
        "--patch-dir", required=True, help="Directory containing patch-LRI results"
    )
