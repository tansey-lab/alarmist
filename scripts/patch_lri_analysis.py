...
def load_patch_lri_results(output_dir: str, sparse_matrix_name: str = 'patch_lri_matrix.npz', 
                           column_df_name: str = 'patch_lri_columns.csv', 
                           meta_df_name: str = 'patch_tma_correspondence.csv', 
    ...
    # Load column names
    columns_file = os.path.join(output_dir, column_df_name)
    ...
    if neighborhood:
        ...
        patch_tma_file = os.path.join(output_dir, meta_df_name)
