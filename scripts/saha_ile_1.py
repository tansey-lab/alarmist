...
# rename Insitutype_Broad to cell_type
...
# ---
# lri_factors = np.load(f'{results_dir}/bptf_{n_components}/lri_factors.npy')
# patch_loadings = np.load(f'{results_dir}/bptf_{n_components}/patch_loadings.npy')
# results = al.load_patch_lri_results(results_dir)
